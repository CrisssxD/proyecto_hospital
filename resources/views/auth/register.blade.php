...
<head>
    ...
    <title>Hospital Regional de Encarnación | Página de registro</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Hospital </b>Regional</a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">Registra una nueva membresía</p>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> Estoy de acuerdo con las <a href="#">condiciones</a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
